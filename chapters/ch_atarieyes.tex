...
\begin{figure}
	...
	\begin{tikzpicture}[
		...
		% Encoders
		\matrix [
			right=of input, row sep=1cm, column sep=0.5cm, nodes={anchor=center},
		] (encoders) {
		...
		\end{pgfonlayer}
	\end{tikzpicture}
	\caption{The disposition of the various classes for the general scheme of
	Figure~\vref{fig:model-scheme}.}
