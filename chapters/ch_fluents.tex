...
variant of PCD, and it's shown in Algorithm~\ref{alg:pcd}.
\begin{algorithm}[thb]
	\centering
	\begin{algorithmic}
		\State Initialize $\linparmat, \bvec{b}, \bvec{c}$
		\State Initialize vectors $\set{\bv_s\group{1}, \dots, \bv_s\group{B}}$
		\EndlessRepeat
			\State Collect a batch $\dataset$ of size $B$ from dataset
			\State Reset batch gradient, $\bvec{g} \gets \zero$
			\For{each sample in batch, $\bv\group{i} \in \dataset$}
	...
	\label{alg:pcd}
\end{algorithm}
% TODO: input dataset of visible vectors
% TODO: change symbol for batch. Correct and complete

% TODO: exmplain algorithm. Implicit parameters given
% TODO: I use expectations here

% TODO: the effect of batches

% TODO: stationary distribution
% TODO: comparison with other algorithms: catch rare samples
...
% TODO: not necessarily binary RBM
