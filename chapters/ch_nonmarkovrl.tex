...
\begin{definition}
	We define a \emph{Regular Decision Process} (RDP)\nomenclature{RDP}{Regular
	Decision Process} to be a NMDP $\modelsym_r \coloneqq \langle \setSym{P}, A,
...
We've shown that a class of POMDPs can be translated to equivalent RDPs. This
...
% Risultato teorico ma non applicabile in pratica per ottenere MDP
...
% Cosa voglio dire
However, in the small remainder of this section, we'd like to discuss how some
