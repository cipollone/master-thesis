...
\documentclass[LaM, binding=1.8cm, noexaminfo]{sapthesis}
...
\newcommand{\boxstairsone}{(0.8188, 0.6143) rectangle (0.8813, 0.6905)}
\newcommand{\boxstairsonebot}{(0.7813, 0.7952) rectangle (0.8813, 0.8619)}
\newcommand{\boxstairstwo}{(0.1187, 0.7952) rectangle (0.1813, 0.8619)}
\newcommand{\boxkey}{(0.0688, 0.4667) rectangle (0.1375, 0.5524)}
...
\include{chapters/ch_nonmarkovrl}
...
% TODO: page layouts and chapters length

% TODO: reorganize references for modified rl chapters
