...
% Listings
\lstset{
	language={}, basicstyle=\linespread{1.0}\small\ttfamily, keywordstyle={},
	commentstyle=\color{gray}, basewidth=0.53em, tabsize=2, numbers=none,
	numberstyle=\tiny, escapeinside={/*_}{_*/}, xleftmargin=3ex,
}
%\lstdefinelanguage{Python3}{Python}{deletekeywords={apply,}}
\lstdefinestyle{python}{
	language=Python, keywordstyle=\color{blue!50!black}\bfseries,
	stringstyle=\color{violet!50!black}, deletekeywords=[2]{apply},
}
\lstdefinestyle{bash}{basicstyle=\ttfamily, language=bash}
\lstdefinestyle{inlinepy}{style=python, basicstyle=\ttfamily}
\lstdefinestyle{inlinesh}{style=bash}
\lstdefinestyle{floatpy}{style=python, float, numbers=left}
\lstdefinestyle{nomargin}{xleftmargin=0ex}
